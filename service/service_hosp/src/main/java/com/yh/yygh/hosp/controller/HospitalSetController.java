...
import com.yh.yygh.common.vo.HospitalSetQueryVo;
...
public class HospitalSetController {
    ...
    public Result findPageHospSet(@PathVariable long current,
        ...
        //调用方法实现分页查询
        IPage<HospitalSet> pageHospitalSet = hospitalSetService.page(page, queryWrapper);
    ...
    public Result saveHospitalSet(@RequestBody HospitalSet hospitalSet) {
        ...
        boolean res = hospitalSetService.save(hospitalSet);
